--[[
    ...
    Funkcje:
    - Automatyczne wykrywanie bazy (Part i Model)
    - Szybki teleport do bazy (poprawiony, niezawodny)
    - GUI: Przesuwalny przycisk, powiadomienia, stylizacja
    - Dźwięk teleportu, dźwięk błędu
    - Zabezpieczenia: sprawdzanie życia gracza, cooldown
    - Auto-find bazy po respawnie
    - Autoheal (jeśli Humanoid ma Health < max)
    - Opcja teleportu do wybranego gracza z listy
    - Pokazanie pozycji bazy na mapie (marker)
    - Panel wyłączania GUI/skryptu
    - Kompatybilny z Part/Model/Folder
]]
...
-- Ulepszone zabezpieczenie przed nadpisaniem GUI
if game.CoreGui:FindFirstChild("LurkhackV4Ultimate") then
    game.CoreGui:FindFirstChild("LurkhackV4Ultimate"):Destroy()
end
gui.Parent = game.CoreGui
